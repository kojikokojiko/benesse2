...
part 'past_exam_score.freezed.dart';
part 'past_exam_score.g.dart';

@freezed
class PastExamScore with _$PastExamScore {
  const factory PastExamScore({
    @Default(0) int  score,
  ...
  factory PastExamScore.fromJson(Map<String, Object?> json)
  => _$PastExamScoreFromJson(json);
}
